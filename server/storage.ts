  ...
  private seedData() {
    ...
    const sampleCampaigns: Campaign[] = [
      ...
      },
      {
        ...
        brandBio: "Brew Coffee Co is a boutique coffee roastery committed to sourcing the finest single-origin beans from sustainable farms around the world. Our expert roasters craft each batch with precision to bring out unique flavor profiles that coffee enthusiasts crave.",
      ...
      },
      {
        ...
        brandBio: "Pure Glow Skincare creates premium, natural skincare products designed for busy college students and young professionals. Our scientifically-formulated products deliver visible results without harsh chemicals.",
